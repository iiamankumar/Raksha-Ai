...
import { FileScan, Bot, ShieldCheck, Activity, Star, Shield } from 'lucide-react';
...
export default function Home() {
  return (
    <div className="w-full min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 pt-32 pb-16 text-center lg:text-left min-h-screen">
                ...
                <div className="w-full max-w-sm">
                    <div className="relative rounded-[2.5rem] border-4 border-slate-700 bg-slate-900 shadow-2xl overflow-hidden">
                        ...
                        <div className="flex justify-around mb-6">
                            <div className="text-center"><div className="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-1"><FileScan className="text-primary w-6 h-6" /></div><p className="text-xs">Scan</p></div>
                            <div className="text-center"><div className="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-1"><Shield className="text-primary w-6 h-6" /></div><p className="text-xs">Shield</p></div>
                        ...
                        <div>
                            ...
                            <div className="flex justify-between items-center"><div className="flex items-center gap-3"><div className="w-8 h-8 rounded-full bg-slate-700 flex items-center justify-center"><Shield className="w-4 h-4" /></div><div><p className="font-medium">Scan Complete</p><p className="text-xs text-slate-400">System Scan</p></div></div><p className="font-mono text-green-400">+ Safe</p></div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            <div className="mb-12 lg:mb-0">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">More Than Just Protection. It's Peace of Mind.</h2>
              <p className="text-muted-foreground text-lg mb-8">Raksha AI goes beyond simple scans to provide a secure and insightful digital experience, protecting you from threats before they happen.</p>
              <ul className="space-y-6">
                <li className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Your data is protected with state-of-the-art encryption and security protocols, ensuring your digital life remains private.</p>
                  </div>
                </li>
                <li className="flex gap-4 items-start">
                  <div className="w-10 h-10 flex-shrink-0 rounded-full bg-primary/20 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Understand what's happening on your network with beautiful, easy-to-read charts and reports.</p>
                  </div>
                </li>
                 <li className="flex gap-4 items-start">
                  <div className="w-10 h-10 flex-shrink-0 rounded-full bg-primary/20 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Get exclusive recommendations and offers from brands you love, just for using Raksha AI.</p>
                  </div>
                </li>
              </ul>
            </div>
                ...
                <div className="w-full max-w-sm">
                    <div className="relative rounded-[2.5rem] border-4 border-slate-700 bg-slate-900 shadow-2xl overflow-hidden">
                        <div className="p-4 pt-6 text-white">
                           <p className="text-sm text-slate-400 text-center">Threat Analysis</p>
                           <p className="text-4xl font-bold text-center mb-4">1,204</p>
                           ...
                           <div className="space-y-4 text-sm">
                                <div>
                                 ...
                                 <div>
                                    ...
                                    <div className="w-full bg-slate-700 rounded-full h-2">
                                        <div className="bg-sky-500 h-2 rounded-full" style={{width: '28%'}}></div>
                                    </div>
                                </div>
                                 <div>
                                    <div className="flex justify-between items-center mb-1">
                           ...
                           <div className="mt-6 bg-green-900/50 border border-green-500/50 rounded-lg p-4 flex items-start gap-4">
                                <Star className="w-8 h-8 text-green-400 flex-shrink-0 mt-1"/>
                                <div>
                                    <h4 className="font-bold text-green-400">Insight</h4>
                                    <p className="text-sm text-green-200/80">You've blocked 15% more phishing attacks this month. Keep your software updated to stay safe.</p>
                                </div>
                           </div>
                        </div>
                    </div>
